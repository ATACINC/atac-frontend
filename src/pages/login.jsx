...
const styles = {
  ...
  tab: (active) => ({ padding: '8px 20px', fontSize: 13, cursor: 'pointer', borderBottom: active ? '2px solid #D4A843' : '2px solid transparent', color: active ? '#D4A843' : 'rgba(245,243,238,0.5)', background: 'none', border: 'none', borderBottom: active ? '2px solid #D4A843' : '2px solid transparent' }),
  ...
  success: { background: 'rgba(29,158,117,0.1)', border: '1px solid rgba(29,158,117,0.3)', borderRadius: 6, padding: '10px 14px', fontSize: 13, color: '#26B589', marginBottom: 16 }
};
    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.tabs}>
          ...
          <button style={styles.tab(tab === 'register')} onClick={() => setTab('register')}>Create Account</button>
        </div>
